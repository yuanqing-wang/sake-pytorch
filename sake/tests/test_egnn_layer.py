...
def test_layer_init():
    import sake
    layer = sake.layers.EGNNLayer(in_features=7, hidden_features=8, out_features=9)
...
def test_layer_simple_graph_equivariant():
    ...
    layer = sake.EGNNLayer(in_features=7, hidden_features=8, out_features=9)
...
def test_layer_simple_graph_equivariant_with_edge():
    import torch
    import dgl
    import sake
    g = dgl.rand_graph(5, 8)
    ...
    layer = sake.EGNNLayer(in_features=7, hidden_features=8, out_features=9, edge_features=1)
