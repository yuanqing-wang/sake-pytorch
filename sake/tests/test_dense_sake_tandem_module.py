...
def test_import():
    import sake
    from sake.models import TandemDenseSAKEModel
    from sake import TandemDenseSAKEModel
...
def test_simple_forward():
    ...
    x = torch.randn(8, 3)
    h = torch.randn(8, 5)
    layer = sake.TandemDenseSAKEModel(5, 6, 7)
    _x, _h = layer(h, x)
...
def test_layer_simple_graph_equivariant():
    ...
    layer = sake.TandemDenseSAKEModel(in_features=7, hidden_features=8, out_features=9)
